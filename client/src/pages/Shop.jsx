          ...
          <form action="" className="flex flex-col gap-4">
            ...
            <section className="flex flex-col gap-2">
              ...
              <label className="input input-bordered flex items-center gap-2">
                ...
                <input type="text" className="grow" placeholder="Owner's name" required />
              </label>
            </section>
            <section className="flex flex-col gap-2">
            ...
            <section className="flex flex-col gap-2">
              ...
              <div className="flex flex-row gap-2 items-center">
                <label className="input input-bordered flex items-center gap-2">
                  ...
                  <input type="text" className="grow" placeholder="Street" required />
                </label>
                <label>
                  <select name="" id="" className="select select-bordered grow" required>
            ...
            <section className="flex flex-col gap-2">
              ...
              <label className="input input-bordered flex items-center gap-2">
                ...
                <input type="text" className="grow" placeholder="DTI Permit #" required />
              </label>
            </section>
